  ...
  return (
    <div className="min-h-full">
      <nav className="bg-slate-800">
        <div className="mx-auto px-3 sm:px-4 lg:px-2">
          <div className="flex h-12 items-center justify-between">
            <div className="flex items-center">
              <div className="flex-shrink-0 text-[#67C7C5]">
              <svg fill="currentColor" width="32" height="32" viewBox="0 0 64 64" preserveAspectRatio="xMidYMid meet">
                <g>
              ...
              <div className="hidden md:block">
                ...
                <a href="#">
                    <ButtonDynamic color="transparent" textcolor="white" fontweight="normal" selected shadow="sm" size="sm">
                      Dashboard
                    </ButtonDynamic>
                  </a>
                  <a href="#">
                    <ButtonDynamic color="transparent" textcolor="white" fontweight="normal" shadow="sm" size="sm">
                      Projects
                    </ButtonDynamic>
                  </a>
                  <a href="#">
                  ...
                  <a>
                    <DropDownButton user={user.name} email={user.email} />
                  </a>
                </div>
              </div>
            </div>
